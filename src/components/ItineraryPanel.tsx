        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex space-x-3">
            <button 
              ...
              className="flex-1 py-3 bg-blue-600/80 hover:bg-blue-700/80 rounded-xl text-white font-medium transition-all duration-300 flex items-center justify-center space-x-2"
            >
              <Calendar className="w-5 h-5" />
              <span>Plan Custom Itinerary</span>
            </button>
            
            <button className="py-3 px-4 bg-white/10 hover:bg-white/20 rounded-xl text-white transition-colors">
